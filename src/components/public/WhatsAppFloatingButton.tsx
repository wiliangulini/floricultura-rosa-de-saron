...
export function WhatsAppFloatingButton({ whatsappNumber }: WhatsAppFloatingButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-10 inline-flex size-14 items-center justify-center rounded-full bg-emerald-600 text-white shadow-lg shadow-zinc-900/20 transition hover:bg-emerald-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-700"
      href={whatsappUrl}
